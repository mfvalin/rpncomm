...
*       Second set of pointers, because of the real *8 type
	real *8, target, allocatable, dimension(:) :: wk_adj
	real *8 wkxs_adj,wkxr_adj,wkys_adj,wkyr_adj,wks_adj
...
*
	...
	entry adj_halo8(g,minx,maxx,miny,maxy,
     %             ni,nj,nk,halox,haloy,periodx,periody)
	globalni=ni
	polarrows=0
	adjoint=.true.
