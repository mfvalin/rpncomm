...
forceitf:
	rm -f $(VPATH)/RPN_COMM_interfaces.inc $(VPATH)/RPN_COMM_interfaces_int.inc
	cd $(VPATH) ; $(MAKE) $(VPATH)/RPN_COMM_interfaces.inc $(VPATH)/RPN_COMM_interfaces_int.inc
...
$(VPATH)/RPN_COMM_interfaces_int.inc: 
