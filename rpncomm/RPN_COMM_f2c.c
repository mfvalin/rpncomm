...
F_C_union RPN_COMM_comm_f2c( MPI_Fint comm) {
  F_C_univ temp;
...
F_C_union RPN_COMM_type_f2c( MPI_Fint type) {
  F_C_univ temp;
...
F_C_union RPN_COMM_group_f2c( MPI_Fint group) {
  F_C_univ temp;
...
F_C_union RPN_COMM_file_f2c( MPI_Fint file) {
  F_C_univ temp;
...
F_C_union RPN_COMM_info_f2c( MPI_Fint info) {
  F_C_univ temp;
...
F_C_union RPN_COMM_op_f2c( MPI_Fint op) {
  F_C_univ temp;
...
F_C_union RPN_COMM_request_f2c( MPI_Fint request) {
  F_C_univ temp;
...
F_C_union RPN_COMM_window_f2c( MPI_Fint win) {
  F_C_univ temp;
